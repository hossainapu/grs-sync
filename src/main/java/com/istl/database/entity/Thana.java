...
/*    */ public class Thana {
    ...
    /*    */
    /*  9 */
    public Thana(Integer id, Integer divisionId, Integer districtId, String nameEnglish, String nameBangla) {
        this.id = id;
    ...
    public static ThanaBuilder builder() {
        /* 13 */
        return new ThanaBuilder();
        /*    */
    }
...
/* Location:              D:\GRS Sync\grs-migrator-prod.jar!\BOOT-INF\classes\com\istl\database\entity\Thana.class
